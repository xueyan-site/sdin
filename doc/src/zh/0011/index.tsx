...
ReactCSRPage，是 \`xt\` 用本配置文件生成的页面对象。其中包含了丰富的页面信息，内容太多，不便一一罗列。建议你打印后查看，或者直接查看[源码](https://github.com/xueyan-site/xueyan-typescript-cli/blob/main/src/pro/react-csr-page.ts)
`
