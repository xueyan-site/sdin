...
const MARK1 = `
接下来，我们以开发 react UI 库为例，学习一下 \`XT\` 开发工具包的流程。
...
> 需要说明的是，在此过程中，你可能会遇到网络卡顿的情况，一般是由于网络环境不好导致的。  
> 你可以按 \`Control\` + \`c\` 结束创建流程。  
> 这时项目其实已经建立好了，只是没有下载依赖模块。  
> 你可以在网络恢复后，进入项目根目录下，手动下载，或者更换NPM镜像源。  
> 换源操作见 “基础教程 / 了解命令” 一文。
